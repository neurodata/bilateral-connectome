    ...
    for n_perturb in n_perturb_range:
        for sim in range(n_sims):
            ...
            for index in choice_indices:
                ...
                # if new_prob > 1:
                #     new_prob = max(base_probs)
                # elif new_prob < 0:
                #     new_prob = min(base_probs)
            ...
            # TODO vectorize somehow? this is the only slow part
            # pvalue_collection = []
            # for cell in range(len(base_samples)):
            ...
            #         method="fisher",
            #     )
            #     pvalue_collection.append(pvalue)
