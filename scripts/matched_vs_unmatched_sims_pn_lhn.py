...
FILENAME = "matched_vs_unmatched_sims_pn_lhn"
...
# right_adj, right_nodes = load_unmatched()
left_nodes["inds"] = range(len(left_nodes))
pn_inds = left_nodes.query("simple_group == 'PNs'")["inds"]
lhn_inds = left_nodes.query("simple_group == 'LHNs'")["inds"]
base_adj = left_adj[pn_inds][:, lhn_inds]
...
effect_sizes = np.linspace(0, 100, 101, dtype=int)
n_sims = 1
rows = []
